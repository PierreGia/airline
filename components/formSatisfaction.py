...
def formsatisfaction():
    ...
    wifi = st.radio("Inflight wifi service :", ("1","2","3","4","5"))

    # Formulaire pour l'Heure de départ/arrivée pratique
    heure_depart_arrivee = st.radio("Departure/Arrival time convenient :", ("1","2","3","4","5"))

    # Formulaire pour la Facilité de réservation en ligne
    reservation = st.radio("Ease of Online booking :", ("1","2","3","4","5"))
    
    # Formulaire pour l'Emplacement de la porte
    emplacemement_porte = st.radio("Gate location:", ("1","2","3","4","5"))
    
    # # Formulaire pour la nourriture
    # food_drink = st.radio("nourriture:", ("0","1", "2","3","4","5"))
    
    #formulaire Embarquement en ligne
    embarquement_ligne = st.radio("Online boarding:", ("1","2","3","4","5"))
    
    #formulaire Confort d'assise
    comfort = st.radio("Seat comfort:", ("1","2","3","4","5"))
    
    # #Divertissement à bord
    # divertissement = st.radio("Divertissement à bord:", ("0","1", "2","3","4","5"))
    
    #formulaire Service à bord
    service = st.radio("On-board service:", ("1","2","3","4","5"))
    ...
    manutention_bagages = st.radio("Baggage handling:", ("1","2","3","4","5"))
